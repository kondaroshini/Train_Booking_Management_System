  ...
  return (
    <div className='NewTrainPage'>
      ...
      <span className='newTrainSpan2'>
        <div className="form-floating mb-3">
                <input type="number" className="form-control" id="floatingInputSeats" value={totalSeats} onChange={(e)=> setTotalSeats(e.target.value)} />
                <label htmlhtmlFor="floatingInputSeats">Total seats</label>
          </div>
          <div className="form-floating mb-3">
