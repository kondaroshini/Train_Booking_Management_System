    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Let's Travel The World Together!!</h1>
            <p className="banner-p">Unleash your travel desires and book extraordinary train journeys that will transport you to unforgettable destinations, igniting a sense of adventure like never before.</p>     
          </div>
                  ...
                  <div className='train-search-container-body'>
                    ...
                    <div className="form-floating">
                      <select className="form-select form-select-sm mb-3"  aria-label=".form-select-sm example" value={departureStation} onChange={(e)=>setDepartureStation(e.target.value)}>
                        ...
                        <option value="Thandur">Thandur</option>
        ...
        <div className="container">
            ...
            <span><h5>2024 RK RailRover- &copy; All rights reserved</h5></span>
